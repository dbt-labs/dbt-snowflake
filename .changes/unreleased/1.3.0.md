...
- Improve column comment handling when `persist_docs` is enabled ([#73](https://github.com/dbt-labs/dbt-snowflake/issues/73), [#100](https://github.com/dbt-labs/dbt-snowflake/issues/1000), [#161](https://github.com/dbt-labs/dbt-snowflake/pull/161))
...
## dbt-snowflake 1.1.0 - March 23, 2022
...
- Remove official support for python 3.6, which is reaching end of life on December 23, 2021 ([#4134](https://github.com/dbt-labs/dbt-core/issues/4134), [#38](https://github.com/dbt-labs/dbt-snowflake/pull/45))
