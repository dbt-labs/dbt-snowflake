_SEEDS__SEED_UPDATE = """ID,FIRST_NAME,LAST_NAME,EMAIL,GENDER,IP_ADDRESS
...
_SEEDS__SEED_MERGE_INITIAL = """ load_date,id,first_name,last_name,email,gender,ip_address
...
_SEEDS__SEED_MERGE_UPDATE = """load_date,id,first_name,last_name,email,gender,ip_address
2021-03-05,1,Jack,Hunter,jhunter0@pbs.org,Male,59.80.20.168
2021-03-05,2,Kathryn,Walker,kwalker1@ezinearticles.com,Female,194.121.179.35
2021-03-05,3,Gerald,Ryan,gryan2@com.com,Male,11.3.212.243
2021-03-05,4,Bonnie,Spencer,bspencer3@ameblo.jp,Female,216.32.196.175
...
_SEEDS__SEED_MERGE_EXPECTED = """load_date,id,first_name,last_name,email,gender,ip_address
2021-03-05,1,Jack,Hunter,jhunter0@pbs.org,Male,59.80.20.168
2021-03-05,2,Kathryn,Walker,kwalker1@ezinearticles.com,Female,194.121.179.35
2021-03-05,3,Gerald,Ryan,gryan2@com.com,Male,11.3.212.243
2021-03-05,4,Bonnie,Spencer,bspencer3@ameblo.jp,Female,216.32.196.175
...
_TESTS__GET_RELATION_QUOTING = """ {%- set tgt = ref('seed') -%}
